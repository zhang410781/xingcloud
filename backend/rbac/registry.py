PERMISSION_DEFINITIONS = [
    ...
    ('ops.middleware.view', '查看中间件资产', 'ops', '查看数据库、Redis、消息队列和搜索集群资产'),
    ('ops.middleware.manage', '管理中间件资产', 'ops', '登记、编辑和删除 Redis、消息队列和搜索集群资产'),
...
BUILTIN_ROLES = [
    ...
    },
    {
        ...
        'permissions': [
            ...
            'cmdb.dashboard.view', 'cmdb.ci.view',
            'cmdb.topology.view', 'cmdb.cost.view', 'cmdb.request.submit',
        ],
    },
    {
        'code': 'security-auditor',
        'name': '审计员',
        'description': '查看日志与安全告警。',
        'permissions': [
            'aiops.knowledge.view',
            'rbac.audit.view', 'aiops.chat.view', 'aiops.chat.analyze', 'aiops.runbook.view', 'aiops.review.view',
            'ops.monitor.dashboard.view',
            'cmdb.dashboard.view', 'cmdb.topology.view', 'cmdb.cost.view',
        ],
    },
    {
        'code': 'read-only',
