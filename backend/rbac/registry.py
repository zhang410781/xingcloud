PERMISSION_DEFINITIONS = [
    ...
    ('cmdb.ci.view', '查看资源中心', 'cmdb', '查看统一资源、负责人、发现源、运行历史与资源关系'),
    ('cmdb.ci.manage', '管理资源中心', 'cmdb', '登记资源、维护负责人、执行自动发现与处理资源冲突'),
    ('cmdb.topology.view', '查看资源关系', 'cmdb', '查看资源之间的包含、运行、部署和依赖关系'),
